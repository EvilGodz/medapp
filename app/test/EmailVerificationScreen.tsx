...
const EmailVerificationScreen: React.FC = () => {
  ...
  const handleResendEmail = async (): Promise<void> => {
    ...
    try {
      const response = await fetch('http://192.168.1.55:3000/api/auth/resend-verification', {
        method: 'POST',
        headers: {
      ...
      <View style={styles.content}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => router.replace('/test/LoginScreen')}
          >
        ...
        <View style={styles.helpContainer}>
          <Text style={styles.helpText}>
            ...
            <Text style={styles.supportEmail}>support@medicineapp.com</Text>
          </Text>
        </View>
      </View>
    </View>
