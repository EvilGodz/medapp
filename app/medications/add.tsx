...
const DURATIONS = [
    ...
    { id: '2', label: '14 วัน', value: 14 },
    { id: '3', label: '30 วัน', value: 30 },
    { id: '4', label: '90 วัน', value: 90 },
    { id: '5', label: 'ต่อเนื่อง', value: -1 },
    { id: '6', label: 'กำหนดเอง', value: 0 },
];
...
export default function addMedicationScreen() {
    ...
    const handleSave = async () => {
        try {
            ...
            Alert.alert(
                "Error",
                "บันทึกยาไม่สำเร็จ กรุณาลองใหม่อีกครั้ง",
                [{ text: "ตกลง" }],
                { cancelable: false },
            );
