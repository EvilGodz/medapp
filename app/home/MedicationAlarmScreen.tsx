import { MedRemind, getMedReminds } from '@/utils/storage';
...
export default function MedicationAlarmScreen({ medicationId }: MedicationAlarmScreenProps) {
    ...
    try {
      ...
      const upcoming = allMeds.filter((med) => {
        ...
        return times.some(time => {
          ...
          return medicationTime >= now && medicationTime <= nextHour;
        });
      });
